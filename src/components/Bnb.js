  ...
  return (
    <div className="lg:h-[774px] h-full w-full bnb">
        <div className="grid lg:grid-cols-2 md:grid-cols-2 justify-center items-center place-items-center">
            <div className="lg:mt-[246px] mb-[265px] mx-[100px] mt-[100px] justify-center items-center place-items-center">
            ...
            <div className="mt-[100px] mb-[99px] justify-center items-center place-items-center">
                <div className="justify-center items-center place-items-center">
                <img src="https://res.cloudinary.com/dpokiomqq/image/upload/v1668271872/image_6_tacw0u.png" alt="image" className="absolute mt-[100px]"/>
                <img src="https://res.cloudinary.com/dpokiomqq/image/upload/v1668271871/image_5_nlaxja.png" alt="image" className="relative "/>
                <img src="https://res.cloudinary.com/dpokiomqq/image/upload/v1668271872/image_7_n26jhk.png" alt="image" className="relative"/>
                </div>
