...
function Cards () {
  return (
    <div className="w-full mt-14">
        ...
        {/* <div className="row-img mt-16 lg:w-full md:[600px]">
        ...
        <div className="text-[#000000] lg:leading-[60px] md:leading-[40px] leading-[30px]  lg:text-5xl text-3xl font-bold grid place-items-center justify-center ">
            <h2 className="text-center">Inspiration for your next adventure</h2>
        </div>

        <div className="grid lg:grid-cols-4 md:grid-cols-2 md:gap-5 justify-center mt-11 lg:mb-[53px] gap-5 lg:gap-0 mb-12">
          ...
          {/* <div className="cards w-[292px]  h-[372px] justify-center lg:ml-[100px] items-center place-items-center">
            <div className="m-4">
          ...
          <div className="cards  w-[292px]  h-[372px]  justify-center lg:mr-[100px] items-center place-items-center">
            <div className="m-4">
          ...
          <div className="cards w-[292px]  h-[372px] justify-center lg:mr-[2000px] items-center place-items-center">
            <div className="m-4">
              <img src="https://res.cloudinary.com/dpokiomqq/image/upload/v1668264713/Frame_2_qejt1g.png" alt="Ntfs"/>
              <div className="flex justify-between">
                <p className="text-[#434343] font-normal text-xs leading-3 mt-3">Desert King</p>
          ...
          {/* <div className="cards  w-[292px] h-[372px]  justify-center items-center place-items-center">
            <div className="m-4">
          ...
          <div className="cards  w-[292px] h-[372px] lg:mx-[100px] justify-center items-center place-items-center">
            <div className="m-4">
          ...
          <div className="cards  w-[292px] h-[372px] m-5 justify-center lg:mr-[100px] items-center place-items-center">
            <div className="m-4">
