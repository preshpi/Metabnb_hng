      ...
      {showModal ? (
        <>
          <div className="h-screen justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative lg:w-[600px] w-[300px] md:w-[500px] my-6 mx-auto lg:max-w-3xl md:max-w-3xl h-[248px]">
              {/*content*/}
              <div className="border-0 rounded-[16px] shadow-lg relative flex flex-col w-full bg-[#FFFFFF] outline-none focus:outline-none">
                ...
                <div className="flex gap-3 p-4 justify-between border-b border-solid border-[#CFD8DC] rounded-t">             
                        <div className="mx-4">
                        <h3 className="lg:text-2xl text-xl font-bold text-[#333333] leading-7">
                        Connect Wallet
                        </h3>                            
                        </div>
                ...
                <div>
                    ...
                    <div className="grid mx-8">
                        <div className="flex lg:w-full md:w-[450px]  w-[260px] rounded-[12px] border-[#CFD8DC] border-solid border hover:bg-[#F8F9FA] bg-[#FFFFFF] cursor-pointer">
                        ...
                        <HiChevronRight className="mt-[26px] mb-[26px] ml-[58px] lg:mt-[26px] lg:mb-[26px] lg:ml-[328px] md:mt-[26px] md:mb-[26px] md:ml-[238px] text-2xl text-[#959DA6]"/>
                        ...
                        <div className="flex lg:w-full w-[260px] md:w-[450px] rounded-[12px] border-[#CFD8DC] border-solid border hover:bg-[#F8F9FA] bg-[#FFFFFF] cursor-pointer mt-3 mb-10">
                            ...
                            <HiChevronRight className="lg:mt-[26px] lg:mb-[26px] lg:ml-[296px] md:mt-[26px] md:mb-[26px] md:ml-[208px] mt-[26px] mb-[26px] ml-[26px] text-2xl text-[#959DA6]"/>
                        </div>
                    </div>
                </div>
